...
from .models import ExamenAlumnoCueanexoL, Pregunta, AlumnosSecundaria, Respuesta, Opcion
...
def guardar_examen(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Crear el examen
            examen = ExamenAlumnoCueanexoL(alumno=alumno)
            examen.save()
            ...
            return redirect('operative:listadol')  # 👈 Asegúrate de que la URL esté configurada en `urls.py`

        else:
            print("Formulario inválido:", form.errors)
            return render(request, 'operativoschaco/examen_formulario.html', {
                'form': form,
