...
from .models import Sanitarios, VCapaUnicaOfertasCuiCuof
from .forms import SanitariosForm
from django.views.generic import CreateView
from django.contrib.auth.mixins import LoginRequiredMixin
from apps.usuarios.models import UsuariosVisualizador

class SanitariosCreateView(LoginRequiredMixin, CreateView):
    model=Sanitarios
    form_class = SanitariosForm
    template_name = 'infra/sanitarios/sanitarios_form.html'        
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Carga de Sanitarios'
        context['entity'] = 'Sanitarios'        
        context['action'] = 'add'
