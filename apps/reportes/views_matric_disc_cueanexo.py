...
def filter_data_matric_disc_ini_cueanexo(request):
    ...
    if request.method == 'POST':     
        ...
        return render(request, 'reportes/matric_disc_ini_cueanexo.html', {'datamatriccueanexo': datamatriccueanexo, 'nvistamatricula': nvistamatricula, 'nrelevamiento':'RELEVAMIENTO 2024'})
