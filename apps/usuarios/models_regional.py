...
class RegionalUsuariosAgentes(models.Model):
    ...
    t_acceso_gestor=models.CharField(max_length=255, default='Gestor')
    rol_gestor=models.CharField(max_length=255, default='Gestor')
...
class RegionalUsuarios(models.Model):
    ...
    region_loc = models.CharField(max_length=100, db_index=True)
    activo = models.BooleanField(default=True, db_index=True)
    t_acceso_regional=models.CharField(max_length=255, default='Regional')
    rol_regional=models.CharField(max_length=255, default='Regional')
    created_at = models.DateTimeField(auto_now_add=True)
