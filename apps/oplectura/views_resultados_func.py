...
def tu_vista_func(request):
    ...
    return render(request, 'oplectura/grafico_func.html', {
...
@login_required
def mostrar_grafico_reg_func(request):
    """
    ...
    if not datos_usuario:
        return render(request, 'oplectura/graficoreg_func.html', {
...
@login_required
def cargar_grafico_reg_func(request):    
    return render(request, 'oplectura/graficoreg_func.html', {
        'datos_disponibles': False
    })
