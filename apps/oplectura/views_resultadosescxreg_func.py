...
def calcular_estadisticas_por_cueanexo(cueanexo):
    """
...
@login_required
def tu_vistacueanexoreg_func(request):
    """
    ...
    if not cueanexo:
        return HttpResponse("Error: No se recibió un cueanexo válido.", status=400)
    ...
    return render(request, 'oplectura/graficocueanexoreg_func.html', {
...
@login_required
def mostrar_grafico_cueanexoreg_func(request):
    """
    ...
    cueanexo_seleccionado = request.GET.get('cueanexo')
    
    print("cueanexo seleccionado:", cueanexo_seleccionado)
    
    mostrar_todo = cueanexo_seleccionado == '0'  # Verifica si se selecciona "Mostrar Todo"
        ...
        with conn.cursor() as cursor:
            if mostrar_todo:                
                ...
                if cueanexo_seleccionado:
                    ...
                    parameters.append(cueanexo_seleccionado)
    ...
    if not datos_usuario:
        return render(request, 'oplectura/graficoxcueanexoreg_func.html', {
    ...
    return render(request, 'oplectura/graficoxcueanexoreg_func.html', {
        ...
        'cueanexo': cueanexo_seleccionado,
        'datos_disponibles': True
    })


@login_required
def cargar_grafico_cueanexoreg_func(request):    
    return render(request, 'oplectura/graficoxcueanexoreg_func.html', {
        'datos_disponibles': False
    })
