...
@login_required
def tu_vistacueanexoreg(request):
    """
    ...
    return render(request, 'oplectura/graficocueanexoreg.html', {
...
@login_required
def mostrar_grafico_cueanexoreg(request):
    """
    ...
    if not datos_usuario:
        return render(request, 'oplectura/graficoxcueanexoreg.html', {
...
@login_required
def cargar_grafico_cueanexoreg(request):    
    return render(request, 'oplectura/graficoxcueanexoreg.html', {
        'datos_disponibles': False
    })
