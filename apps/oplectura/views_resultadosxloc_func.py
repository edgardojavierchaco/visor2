...
@login_required
def mostrar_grafico_loc_func(request):
    """
    ...
    if not datos_usuario:
        return render(request, 'oplectura/graficoxloc_func.html', {
...
@login_required
def cargar_grafico_loc_func(request):    
    return render(request, 'oplectura/graficoxloc_func.html', {
        'datos_disponibles': False
    })


def mostrar_grafico_localidad_func(request):
    """
    ...
    return render(request, 'oplectura/graficoxloc_func.html', context)
