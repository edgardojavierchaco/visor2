...
class VistaAlumnosBilingueListView(LoginRequiredMixin, ListView):
    model = VistaAlumnosBilingue
    template_name = 'intercultural/alumnos/list_func.html'
...
class VistaAlumnosBilingueListView2(LoginRequiredMixin, ListView):
    model = VistaAlumnosBilingue
    template_name = 'intercultural/alumnos/list_func_cue.html'
    #permission_required = 'apps.view_supervisor'    
