...
class VistaAlumnosBilingueGestorListView(LoginRequiredMixin, ListView):
    model = VistaAlumnosBilingue
    template_name = 'intercultural/alumnos/list_gestor.html'
...
class VistaAlumnosBilingueGestorListView2(LoginRequiredMixin, ListView):
    model = VistaAlumnosBilingue
    template_name = 'intercultural/alumnos/list_gestor_cue.html'
    #permission_required = 'apps.view_supervisor'    
