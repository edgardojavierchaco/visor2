...
def calcular_estadisticas_por_cueanexo(username):
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute("""
            ...
            FROM public.teslecturamayo
            WHERE cueanexo in %s AND desempenio !='Calificación Incorrecta' AND desempenio !='Sin Calificar'
        """, [cueanexo])
...
def tu_vista(request):
    ...
    for i in cueanexos:
        ...
        print(f'lista{lista_cueanexos_validos}')
    #print(lista_cueanexos_validos)
    #HABLAR CON EDGARDO
    resultados_total_dni, total_dni_sin_desempenio, resultado_promedio_puntaje = calcular_estadisticas_por_cueanexo(lista_cueanexos_validos)
