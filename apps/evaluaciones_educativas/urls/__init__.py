...
from apps.evaluaciones_educativas.views import dashboard
...
urlpatterns = [
    ...
    path('fluidez_octubre_2026/', include('apps.evaluaciones_educativas.urls.fluidez_octubre_2026', namespace='fluidez_octubre_2026')),
