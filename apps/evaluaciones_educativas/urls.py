...
urlpatterns = [
    ...
    path('analisis_completo_evaluacion_noviembre_2025/',views.analisis_evaluaciones_ministros_noviembre_2025, name='analisis_completo_evaluacion_noviembre_2025'),
    path('analisis_evaluacion_noviembre_2025/',views.analisis_evaluaciones_regional_noviembre_2025, name='analisis_evaluacion_noviembre_2025'),
    path('analisis_evaluaciones_mayo_2025/',views.analisis_evaluaciones_mayo_2025, name='analisis_evaluacion_mayo_2025')
