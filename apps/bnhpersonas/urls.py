...
urlpatterns = [
    ...
    path("verificar-persona-alta/", views.verificar_persona_alta, name="verificar_persona_alta"),
    path("buscar-persona-vincular/", views.buscar_persona_vincular, name="buscar_persona_vincular"),
    ...
    path("filtrar-datos-curriculares/", views.filtrar_datos_curriculares, name="filtrar_datos_curriculares"),
    path("filtrar-condiciones-actividad/", views.filtrar_condiciones_actividad, name="filtrar_condiciones_actividad"),
