...
CAMPO_SQL = {
    'cue_anexo': "CONCAT(vl.cue::text, LPAD(COALESCE(BTRIM(vl.anexo), ''), 2, '0'))",
    'cue': 'vl.cue::text',
...
SEARCH_FIELD_TYPES.update({
    ...
    'cod_area_tel': IDENTIFIER_DIGITS,
    'telefono': IDENTIFIER_DIGITS,
    'tel_director_regional': IDENTIFIER_DIGITS,
    'nro_biblioteca': IDENTIFIER_DIGITS,
