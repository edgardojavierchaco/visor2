...
class BibliotecariosCueCreateView(LoginRequiredMixin, InformeBloqueoMixin,CreateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        print("cueanexo sesion:", cueanexo)
            ...
            if action == 'add':
                ...
                if form.is_valid():
                    ...
                    if not cueanexo:
                        return JsonResponse({
                            'error': True,
                            'message': 'No hay cueanexo activo en sesión'
                        })
    ...
    def get_context_data(self, **kwargs):
        ...
        cueanexo = self.request.session.get("cueanexo_activo")
        print("cueanexo activo:",cueanexo)
...
# UPDATE
# =========================================================
class BibliotecariosCueUpdateView(InformeBloqueoMixin,LoginRequiredMixin ,UpdateView):
    model = BibliotecariosCue
    form_class = BibliotecariosCueForm
    template_name = 'biblioteca/pem/personal/create.html'
    success_url = reverse_lazy('bibliotecas:bibliotecario_list')
...
class BibliotecariosCueListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        if not cueanexo:
            return BibliotecariosCue.objects.none()
        
        qs = BibliotecariosCue.objects.filter(cueanexo=cueanexo)
