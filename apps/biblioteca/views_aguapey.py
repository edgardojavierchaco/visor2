...
class AguapeyCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        ultimo_informe = GenerarInforme.objects.filter(cueanexo_qs.first() if cueanexo_qs.exists() else None).order_by('-annos', '-meses').first()
...
class AguapeyListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):    
        ...
        serviciosref = Aguapey.objects.filter(cueanexo=cueanexo_qs.first() if cueanexo_qs.exists() else None)
