        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="../update/' + row.id + '/" class="btn btn-warning btn-xs btn-flat disabled" aria-disabled="true"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="../delete/' + row.id + '/" class="btn btn-danger btn-xs btn-flat disabled" aria-disabled="true"><i class="fas fa-trash-alt"></i></a>'; 
                    return buttons;
                }
            },
        ],
