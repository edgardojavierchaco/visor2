        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="' + deleteUrlTemplate + row.id + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash-alt"></i></a> ';
                    buttons += '<a href="' + updateUrlTemplate + row.id + '/" class="btn btn-warning btn-xs btn-flat"><i class="fas fa-edit"></i></a> ';
