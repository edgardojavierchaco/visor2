$(function () {
    $('#data').DataTable({
        ...
        columnDefs: [{
            ...
            render: function (data, type, row) {
                var /* buttons = '<a href="../editar_fluidez/' + row.id + '/" class="btn btn-warning btn-xs btn-flat"><i class="fas fa-edit"></i></a> ';
                buttons += '<a href="../eliminar_fluidez/' + row.id + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash-alt"></i></a>'; */
    ...
    $('#data tbody').on('click', 'button.view-pdf', function () {
        ...
        $.post("/cargar/buscar_fluidez/", { action: 'buscar_pdf_por_id', id:id }, function (response) {
